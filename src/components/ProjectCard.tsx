      ...
      <div className="flex gap-4">
        ...
        {project.githubReleaseUrl && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex-1 bg-green-500 text-white text-center py-2 px-4 rounded hover:bg-green-600 transition-colors"
          >
            ダウンロード
          </a>
        )}
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex-1 bg-gray-800 text-white text-center py-2 px-4 rounded hover:bg-gray-900 transition-colors"
        >
          GitHub
        </a>
      </div>
